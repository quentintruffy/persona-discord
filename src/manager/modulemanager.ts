/**
 * Gestionnaire de modules pour un bot Discord
 * Ce module gère le chargement dynamique des modules contenant des commandes et des événements
 */
  ...
  private async loadModuleEvents(
    ...
    try {
      ...
      for (const file of eventFiles) {
        ...
        const event: IEvent<keyof ClientEvents> = await this.importEvent(
          filePath
        );
